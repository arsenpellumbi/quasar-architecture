        ...
        <q-card class="my-card q-mb-mb" square>
          <q-card-section>
            <div class="row items-center no-wrap">
              <div class="row col">
                <div class="text-h6 q-mr-sm">Readme:</div>
              </div>
            </div>
          </q-card-section>
          <q-card-section>
            ...
            original form, accompanied by English versions from the 1914 translation by H. Rackham. Where can I get
            some? There are many variations of passages of Lorem Ipsum available, but the majority have suffered
            ...
            non-characteristic words etc.</q-card-section
          >
        </q-card>
      </q-page>
    </template>
